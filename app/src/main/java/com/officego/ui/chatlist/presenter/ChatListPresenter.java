...
public class ChatListPresenter extends BasePresenter<ChatListContract.View>
    ...
    public void getChatList() {
        ...
        OfficegoApi.getInstance().getChatList(new RetrofitCallback<List<ChatListBean>>() {
            @Override
            public void onSuccess(int code, String msg, List<ChatListBean> data) {
                if (isViewAttached()) {
                    mView.hideLoadingDialog();
                    mView.chatListSuccess(data);
                }
            }

            @Override
            public void onFail(int code, String msg, List<ChatListBean> data) {
                if (isViewAttached()) {
