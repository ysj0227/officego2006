...
public class CollectBuildingBean {
    ...
    public static class ListBean {
         ...
         * remark :
         * areaMap : [22,22]
         * buildingMap : {"stationNames":["漕河泾开发区"],"stationline":["9"],"nearbySubwayTime":["1"],"stationColours":["#7ACDF5"]}
