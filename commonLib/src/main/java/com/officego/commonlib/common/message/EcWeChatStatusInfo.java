 ...
 * 微信同意和拒绝
 */
@MessageTag(value = "og:exwx", flag = MessageTag.ISPERSISTED | MessageTag.ISCOUNTED)
public class EcWeChatStatusInfo extends MessageContent {
    ...
    public static EcWeChatStatusInfo setWeChatData(String content, String sendNumber, String receiveNumber,
    ...
    public EcWeChatStatusInfo() {
    }

    public EcWeChatStatusInfo(byte[] data) {
        super(data);
        String jsonStr = null;
        try {
    ...
    public static final Creator<EcWeChatStatusInfo> CREATOR = new Creator<EcWeChatStatusInfo>() {

        @Override
        public EcWeChatStatusInfo createFromParcel(Parcel source) {
            return new EcWeChatStatusInfo(source);
        }

        @Override
        public EcWeChatStatusInfo[] newArray(int size) {
            return new EcWeChatStatusInfo[size];
        }
    };


    public EcWeChatStatusInfo(Parcel parcel) {
